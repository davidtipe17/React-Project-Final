        ...
        <div>
            <header className="home">
                ...
                <div className="carousel">
                    <div id="carouselHome" className="carousel carousel slide" data-bs-ride="carousel">
            ...
            <main className="mt-5">
                    ...
                    <div className=" d-flex flex-column align-items-center">
                        ...
                        <div className="row info mt-2">
                            <div className="col-xs-12 col-md-6 mb-3">
                                ...
                                <p>Sistema de evaluación y/o revisión, mediante el cual se determinan las necesidades
                                    de mantenimiento o reparación de un equipo, comparando sus párametros de funcionamiento
                                    con los establecidos por los fabricantes.
                                </p>
                            </div>
                            <div className="col-xs-12 col-md-6 mb-3">
                                <div className="icon">
                                ...
                                <p>Es una explicación detallada por escrito, de las circunstancias observadas en el diagnóstico del equipo,
                                    con expecificaciones detalladas que certifiquen lo dicho por el área técnica.
                                </p>
                            </div>
                            <div className="col-xs-12 col-md-6 mb-3">
                                <div className="icon">
                                ...
                                <p>Son actividades técnicas que se realizan de manera anticipado con el fin de prevenir el surgimiento
                                    de averías en los artefactos, equipos electronicos, etc., estás actividades incluyen repuestos y/o
                                    accesorios que se desgastan.
                                </p>
                            </div>
                            <div className="col-xs-12 col-md-6 mb-3">
                                <div className="icon">
                                ...
                                <p>Se denomina aquel servicio que como principal finalidad es corregir los fallos o defectos que se presentan
                                    en equipos y maquinarias, que no se encuentran enlistados en los servicios preventivos.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="bar-suscribe">
                    <div className="container d-xs-block d-md-flex py-5">
                        <span>
                            Suscribete a nuestro Boletín de Noticias. Recibe noticias e información relacionadas con el mundo del Soporte
                        </span>
                        <div className="input-group mt-2 mt-md-0 mb-3 suscribe-group">
                            <input type="text" className="form-control py-2" placeholder="Escribe tu correo" aria-label="Recipient's username" aria-describedby="button-addon2"/>
