const FilterTicketProcess = ({filteredTicketsProcess}) => {
    return (
      <div
      ...
      >
        <table className="table  ">
          ...
          {filteredTicketsProcess?.length > 0 ? (
            filteredTicketsProcess.map((ticket, index) => (
  ...
  export default FilterTicketProcess;
